...
#     lang=character(),
#     desc=list(),
#     tokens=cbind(init.kRp.text.df(), data.frame(token.orig=NA, equal=NA)),
#     diff=list()),
#   contains=c("kRp.text")
# )
# 
# # @include 01_class_01_kRp.text.R
# setAs(from="kRp.txt.trans", to="kRp.text", function(from){
...
#     valid_cols=c(valid.tokens.kRp.text, "token.orig", "equal"),
#     strict=FALSE,
#     warn_only=FALSE,
#     name="tokens"
#   )
