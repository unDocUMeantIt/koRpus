...
function calculate(){
	...
	var FleschESS = getBoolean("FleschESS.state");
	...
	var valueFleschESS = getValue("FleschESS");
	...
	arrIndex.push(valueARI, valueARINRI, valueBormuth, valueColeman, valueColemanLiau, valueDaleChall, valueDaleChallPSK, valueDaleChallOld, valueDanielsonBryan, valueDickesSteiwer, valueDRP, valueELF, valueFarrJenkinsPaterson, valueFarrJenkinsPatersonPSK, valueFlesch, valueFleschDE, valueFleschES, valueFleschESS, valueFleschFR, valueFleschNL, valueFleschPSK, valueFleschKincaid, valueFOG, valueFOGPSK, valueFOGNRI, valueFORCAST, valueFORCASTRGL, valueFucks, valueHarrisJacobson, valueLinsearWrite, valueLIX, valueNWS, valueQu, valueRIX, valueSMOG, valueSMOGC, valueSMOGsimple, valueSpache, valueSpacheOld, valueStrain, valueTRI, valueTuldava, valueWheelerSmith, valueWheelerSmithDe);
